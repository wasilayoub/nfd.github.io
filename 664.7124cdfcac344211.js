      ...
      let w = (0, s.forwardRef)(function (e, t) {
        let {
          ...
          B = (0, s.useRef)(null),
          {
            ...
            return (
              ...
              { params: i, passedParams: a, rest: o, events: s }
            );
          })(T),
        ...
        let q = () => {
          if (
            ...
            G.loop && (_.current.loopedSlides = u(R, G)),
                ...
                G.virtual
                  ? (function (e, t, i) {
                      ...
                      return t
                        ...
                        .map((t) => s.cloneElement(t, { swiper: e, style: r }));
                    })(_.current, R, M)
                  : !G.loop || (_.current && _.current.destroyed)
                  ? R.map((e) => s.cloneElement(e, { swiper: _.current }))
                  : (function (e, t, i) {
                      let r = t.map((t, i) =>
                        s.cloneElement(t, {
                          swiper: e,
                      ...
                      for (let e = 0; e < n; e += 1) {
                        ...
                        o.push(l(r[t], e, "append")),
                          a.unshift(l(r[r.length - t - 1], e, "prepend"));
                      }
    ...
    71911: function (e, t, i) {
      ...
      let b = {
        ...
        on: function (...e) {
          ...
          "function" == typeof e[1] && (([i, r, l] = e), (s = void 0)),
            l || (l = !1);
          let o = i.split(" ");
            ...
            if (s)
              ...
              for (t = 0; t < o.length; t += 1) {
                ...
                i.dom7Listeners || (i.dom7Listeners = {}),
                  ...
                  i.dom7Listeners[e].push({ listener: r, proxyListener: a }),
          ...
          for (let e = 0; e < l.length; e += 1) {
            ...
            for (let e = 0; e < this.length; e += 1) {
              ...
              if (
                (!i && n.dom7Listeners
                  ? (l = n.dom7Listeners[t])
                  : i && n.dom7LiveListeners && (l = n.dom7LiveListeners[t]),
                l && l.length)
              )
        ...
        offset: function () {
          if (this.length > 0) {
            ...
            return { top: s.top + a - l, left: s.left + o - n };
          }
          return null;
        },
        css: function (e, t) {
            ...
            for (let i = 0, s = e.length; i < s; i += 1) {
              ...
              void 0 !== l &&
                ...
                (S(t[s]) && S(r[s])
                  ...
                  : !S(t[s]) && S(r[s])
                  ? ((t[s] = {}),
                    r[s].__swiper__ ? (t[s] = r[s]) : T(t[s], r[s]))
                  : (t[s] = r[s]));
            }
          }
        }
        ...
        let o = t > l ? "next" : "prev",
          ...
          p = () => {
            ...
            let o = Math.max(Math.min((s - n) / a, 1), 0),
              c = l + (0.5 - Math.cos(o * Math.PI) / 2) * (t - l);
            if (
      ...
      function k(e) {
        ...
        if (s.isTouchEvent && r.touchReleaseOnEdges && !r.loop) {
          if (i.isVertical()) {
            if (
              (u < l.startY && i.translate <= i.maxTranslate()) ||
              (u > l.startY && i.translate >= i.minTranslate())
            ) {
              (s.isTouched = !1), (s.isMoved = !1);
              return;
            }
          } else if (
            (c < l.startX && i.translate <= i.maxTranslate()) ||
            (c > l.startX && i.translate >= i.minTranslate())
          )
            return;
        }
        if (
      ...
      function $(e) {
        ...
        for (
          ...
          void 0 !== a[e + i]
            ? t >= a[e] && t < a[e + i] && ((u = e), (h = a[e + i] - a[e]))
            : t >= a[e] && ((u = e), (h = a[a.length - 1] - a[a.length - 2]));
        }
        let f = null,
          m = null;
        r.rewind &&
        ...
        if (c > r.longSwipesMs) {
          ...
          "next" === i.swipeDirection &&
            (g >= r.longSwipesRatio
              ? i.slideTo(r.rewind && i.isEnd ? f : u + v)
              : i.slideTo(u)),
            "prev" === i.swipeDirection &&
      ...
      let D = (e, t) => {
          ...
          if (o.touch) {
            ...
            l[c](r.start, e.onTouchStart, t),
              l[c](
                r.move,
                e.onTouchMove,
                o.passiveListener ? { passive: !1, capture: p } : p
              ),
              l[c](r.end, e.onTouchEnd, t),
              r.cancel && l[c](r.cancel, e.onTouchEnd, t);
          } else
          ...
          eventsEmitter: {
            ...
            emit(...e) {
              ...
              "string" == typeof e[0] || Array.isArray(e[0])
                ...
                : ((t = e[0].events), (i = e[0].data), (s = e[0].context || r)),
                i.unshift(s);
          ...
          update: {
            ...
            updateSlides: function () {
              ...
              "string" == typeof C &&
                ...
                r.centeredSlides &&
                  r.cssMode &&
                  (y(t.wrapperEl, "--swiper-centered-offset-before", ""),
                  y(t.wrapperEl, "--swiper-centered-offset-after", ""));
                  ...
                  if ("auto" === r.slidesPerView) {
                    ...
                    if (
                      ...
                      if (d && "border-box" === d) e = t + l + o;
                        ...
                        let { clientWidth: s, offsetWidth: n } = a[0];
                        e = t + i + r + l + o + (n - s);
                      }
                    }
              ...
              if (
                ((t.virtualSize = Math.max(t.virtualSize, n) + v),
                a &&
                  o &&
                  ("slide" === r.effect || "coverflow" === r.effect) &&
                  l.css({ width: `${t.virtualSize + r.spaceBetween}px` }),
                r.setWrapperSize &&
                  l.css({
              ...
              if (
                ...
                y(t.wrapperEl, "--swiper-centered-offset-before", `${-h[0]}px`),
                  y(
                    t.wrapperEl,
            ...
            updateSlidesProgress: function (e = (this && this.translate) || 0) {
              ...
              for (let e = 0; e < s.length; e += 1) {
                ...
                let d =
                    (n + (i.centeredSlides ? t.minTranslate() : 0) - o) /
                    (a.swiperSlideSize + i.spaceBetween),
                  p =
                    (n - l[0] + (i.centeredSlides ? t.minTranslate() : 0) - o) /
                    (a.swiperSlideSize + i.spaceBetween),
                  c = -(n - o),
            ...
            updateProgress: function (e) {
              ...
              let t = this.params,
                ...
                { progress: s, isBeginning: r, isEnd: l } = this,
                n = r,
                a = l;
              0 === i
                ? ((s = 0), (r = !0), (l = !0))
                : ((r = (s = (e - this.minTranslate()) / i) <= 0),
                  (l = s >= 1)),
                Object.assign(this, { progress: s, isBeginning: r, isEnd: l }),
                (t.watchSlidesProgress || (t.centeredSlides && t.autoHeight)) &&
                  this.updateSlidesProgress(e),
                r && !n && this.emit("reachBeginning toEdge"),
                l && !a && this.emit("reachEnd toEdge"),
                ((n && !r) || (a && !l)) && this.emit("fromEdge"),
                  ...
                  l.WebKitCSSMatrix
                    ? ((s = n.transform || n.webkitTransform).split(",")
                        ...
                        (s = s
                          ...
                          .map((e) => e.replace(",", "."))
                          .join(", ")),
                      (r = new l.WebKitCSSMatrix("none" === s ? "" : s)))
                    : (i = (r =
                        n.MozTransform ||
                        n.OTransform ||
                        n.MsTransform ||
          ...
          loop: {
            loopCreate: function () {
              ...
              for (let e = 0; e < a.length; e += 1)
                r.append(m(a[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
              for (let e = n.length - 1; e >= 0; e -= 1)
                r.prepend(
                  m(n[e].cloneNode(!0)).addClass(i.slideDuplicateClass)
                );
            },
            loopFix: function () {
              let e;
          ...
          events: {
            attachEvents: function () {
              ...
              (e.onTouchStart = P.bind(e)),
                ...
                s.touch &&
                  !z &&
                  (t.addEventListener("touchstart", A), (z = !0)),
                D(e, "on");
            },
          ...
          breakpoints: {
              ...
              p && !c
                ...
                : !p &&
                  ...
                  ((d.grid.fill && "column" === d.grid.fill) ||
                    ...
                    l.addClass(`${r.containerModifierClass}grid-column`),
                  e.emitContainerClasses()),
            ...
            getBreakpoint: function (e, t = "window", i) {
              ...
              for (let e = 0; e < n.length; e += 1) {
                let { point: l, value: a } = n[e];
                "window" === t
                  ? r.matchMedia(`(min-width: ${a}px)`).matches && (s = l)
                  : a <= i.clientWidth && (s = l);
              }
              return s || "max";
            },
      ...
      function R({ swiper: e, extendParams: t, on: i, emit: s }) {
        ...
        function p() {
            ...
            if (
              (l.dynamicBullets &&
                ...
                (d =
                  ((a =
                    (s = Math.max(t - n, 0)) +
                    (Math.min(c.length, l.dynamicMainBullets) - 1)) +
                    s) /
                  2)),
              c.removeClass(
              ...
              c.each((e) => {
                let i = m(e),
                  r = i.index();
                r === t && i.addClass(l.bulletActiveClass),
                  l.dynamicBullets &&
                    (r >= s &&
                      r <= a &&
                      i.addClass(`${l.bulletActiveClass}-main`),
                    r === s && o(i, "prev"),
                    r === a && o(i, "next"));
              });
            else {
              ...
              if ((i.addClass(l.bulletActiveClass), l.dynamicBullets)) {
                let t = c.eq(s),
                  i = c.eq(a);
                for (let e = s; e <= a; e += 1)
                  c.eq(e).addClass(`${l.bulletActiveClass}-main`);
                if (e.params.loop) {
                  if (r >= c.length) {
                    for (let e = l.dynamicMainBullets; e >= 0; e -= 1)
                      c.eq(c.length - e).addClass(
                        `${l.bulletActiveClass}-main`
                      );
                    c.eq(c.length - l.dynamicMainBullets - 1).addClass(
                      `${l.bulletActiveClass}-prev`
                    );
          ...
          if (
            ("fraction" === l.type &&
              (p.find(F(l.currentClass)).text(l.formatFractionCurrent(t + 1)),
              p.find(F(l.totalClass)).text(l.formatFractionTotal(c))),
            "progressbar" === l.type)
          ) {
            let i;
            i = l.progressbarOpposite
              ? e.isHorizontal()
                ? "vertical"
                : "horizontal"
              : e.isHorizontal()
            ...
            let s = (t + 1) / c,
              r = 1,
              n = 1;
            "horizontal" === i ? (r = s) : (n = s),
              p
                .find(F(l.progressbarFillClass))
                .transform(`translate3d(0,0,0) scaleX(${r}) scaleY(${n})`)
                .transition(e.params.speed);
          }
          "custom" === l.type && l.renderCustom
            ? (p.html(l.renderCustom(e, t + 1, c)), s("paginationRender", p[0]))
            : s("paginationUpdate", p[0]),
            e.params.watchOverflow &&
              e.enabled &&
              p[e.isLocked ? "addClass" : "removeClass"](l.lockClass);
        }
        function c() {
        ...
        function u() {
              ...
              e.params.createElements &&
                Object.keys(s).forEach((l) => {
                  if (!i[l] && !0 === i.auto) {
                    ...
                    n ||
                      (((n = r.createElement("div")).className = s[l]),
                      e.$el.append(n)),
                      (i[l] = n),
                      (t[l] = n);
                  }
          ...
          0 === i.length ||
            ...
            t.clickable &&
              i.on("click", F(t.bulletClass), function (t) {
                t.preventDefault();
